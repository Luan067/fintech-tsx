  ...
  return (
    <ResponsiveContainer width="99%" height={400}>
      <LineChart data={transformedData}>
        ...
        <Tooltip />
        <Legend />
        <Line type="monotone" dataKey="pago" stroke="#22C55E" strokeWidth={3} />
        <Line type="monotone" dataKey="processando" stroke="#EAB308" strokeWidth={3} />
        <Line type="monotone" dataKey="falha" stroke="#DC2626" strokeWidth={3} />
      </LineChart>
    </ResponsiveContainer>
  );
};
